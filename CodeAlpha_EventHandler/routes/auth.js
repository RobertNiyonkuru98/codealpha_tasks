...
router.get('/register', register) // Loading the page with the form to register for an event
router.post('/register', registerUser) // Submitting the form to register for an event
